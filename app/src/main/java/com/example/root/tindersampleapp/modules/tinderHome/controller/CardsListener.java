...
public class CardsListener implements View.OnTouchListener {
    private static final String TAG = CardsListener.class.getSimpleName();
    ...
    public CardsListener(View frame, Object itemAtPosition, FlingListener flingListener) {
        this(frame, itemAtPosition, 15f, flingListener);

    }

    public CardsListener(View frame, Object itemAtPosition, float rotation_degrees, FlingListener flingListener) {
        super();
    ...
    public boolean onTouch(View view, MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                TinderCardsActivity.removeBackground();
